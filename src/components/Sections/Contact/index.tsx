...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-emerald-300/80" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <EnvelopeIcon className="hidden h-16 w-16 text-neutral-700 md:block" />
          <h2 className="text-2xl font-bold text-neutral-700">{headerText}</h2>
        </div>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="order-1 col-span-1 flex flex-col gap-y-4 md:order-2">
            <p className="prose leading-6 text-neutral-300"></p>
